from open_cv_library.images import (
    ...
    detect_and_mark_faces
)
from resources.resources import (
    f1, f2, m1, m2, g1, f1_rotated, f2_negative, f1_gray, f2_rectangle, m2_invcua, m1_par,
    m2_mirror, m2_inverted, m2_prueba, m2_html, f2_rectangle_text, f2_blurred, g1_detected
)
...
get_image_blurred(f2, f2_blurred, (1500, 2000), (250, 800))
